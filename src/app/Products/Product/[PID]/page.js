  ...
  return (
    <div className=" md:m-2 flex-col  flex gap-5 m-0">
      <div className="flex gap-5    md:flex-row flex-col-reverse">
        <div className="w-full  bg-ground   p-5 rounded-sm md:rounded-md  text-justify ">
          <ProductDetailTop product={product} />
          <p className="text-xl font-semibold py-2">Description</p>
          <article
            className=" font-serif se-wrapper-inner se-wrapper-wysiwyg sun-editor-editable text-justify  "
          ...
          <div className="mt-5">
            ...
            <div className="mt-2">
              <p className="uil  text-sm flex gap-2 items-center  uil-envelope">
                wealthsummit@wealthsummit.shop
              </p>
              <p className="uil  text-sm flex gap-2 items-center  uil-phone">
                +91 7796305802
              </p>
            </div>
          </div>
        </div>
        <div className="   hidden md:relative md:z-0 z-10  p-5 bottom-0 left-0 md:flex    w-full md:w-[40%]     gap-2 flex-col   text-justify ">
