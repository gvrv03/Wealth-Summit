...
const TermsCondition = () => (
  <div className="text-justify border p-5 border-gray-700 rounded-sm mt-5 md:rounded-md">
    ...
    <p className="mb-4">
      ...
      manage your use of our website, Wealth Summit accessible at
      www.wealthsummit.shop.
    </p>
    <p className="mb-4">
      Minors or people below 18 years old are not allowed to use this Website.
    </p>

    <h2 className="text-lg font-semibold mb-2">Intellectual Property Rights</h2>
    <p className="mb-4">
      Other than the content you own, under these Terms, Wealth Summit and/or
    ...
    <h2 className="text-lg font-semibold mb-2">Restrictions</h2>
    <p className="mb-4">
    ...
    <p className="mb-4">
      ...
      Wealth Summit may further restrict access by you to any areas of this
    ...
    <p className="mb-4">
      In no event shall Wealth Summit, nor any of its officers, directors and
      ...
      contract. Wealth Summit, including its officers, directors and employees
    ...
    <p className="mb-4">
      You hereby indemnify to the fullest extent Wealth Summit from and against
    ...
    <h2 className="text-lg font-semibold mb-2">Severability</h2>
    <p className="mb-4">
    ...
    <h2 className="text-lg font-semibold mb-2">Variation of Terms</h2>
    <p className="mb-4">
      Wealth Summit is permitted to revise these Terms at any time as it sees
    ...
    <p className="mb-4">
      The Wealth Summit is allowed to assign, transfer, and subcontract its
    ...
    <p className="mb-4">
      These Terms constitute the entire agreement between Wealth Summit and you
      in relation to your use of this Website, and supersede all prior
      agreements and understandings.
    </p>

    <h2 className="text-lg font-semibold mb-2">Governing Law & Jurisdiction</h2>
    <p className="mb-4">
      These Terms will be governed by and interpreted in accordance with the
      laws of the State of in, and you submit to the non-exclusive jurisdiction
      of the state and federal courts located in in for the resolution of any
      disputes.
    </p>
  </div>
);
