...
const page = () => {
  return (
    <div className="text-justify border p-5 border-gray-700  rounded-sm mt-5 md:rounded-md">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Wealth Summit.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Wealth Summit, accessible from{" "}
            <a
              href="https://www.wealthsummit.shop"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.wealthsummit.shop
            </a>
          </p>
        </li>
        <li>
      ...
      <p>
        Usage Data may include information such as Your Device is Internet
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            such as a mobile application is push notifications regarding updates
      ...
      <p>
        Your information, including Personal Data, is processed at the Company is
      ...
      <p>
        ...
        require Your parent is consent before We collect and use that
        information.
      </p>
      ...
      <p>
        ...
        third party is site. We strongly advise You to review the Privacy Policy
      ...
      <ul>
        <li>
          <p>By email: wealthsummit@wealthsuummit.shop</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://www.wealthsuummit.shop/ContactUs"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.wealthsuummit.shop/ContactUs
            </a>
          </p>
        </li>
      </ul>
